...
function displayBasket(){
    ...
    //Si le panier contient des produits (égal ou supérieur à 1 article)
        ...
        for(k = 0; k < basketContent.length; k++){
            arrayBasketStructure = arrayBasketStructure + `
            <div class="d-flex justify-content-between p-3 rounded" >
                <img class="rounded d-block d-md-none" id="product__img" src="${basketContent[k].img}" alt="Modèle appareil photo Zurss 50S" width="100" height="100">
                <img class="rounded d-none d-md-block" id="product__img" src="${basketContent[k].img}" alt="Modèle appareil photo Zurss 50S" width="200">
            <div class="d-flex flex-column align-items-center pt-4">
                <h3 id="product__name">${basketContent[k].name}</h3>
                <p id="product__option">${basketContent[k].option}</p>
            </div>
            <div class="d-flex flex-row align-items-center">
                <button class="btn" type="button" aria-hidden="true" id="remove1FromBasket">
                ...
                <h5 class="pt-2" id="product__quantity">${basketContent[k].quantity}</h5>
                <button class="btn" type="button" aria-hidden="true" id="add1ToBasket">
            ...
            <div class="d-flex flex-row align-items-center">
                <p class="pt-3" ><strong id="product__price">${showPrices(basketContent[k].price)}</strong></p>
            </div>
            <div class="d-flex flex-row align-items-center">
                <button class="btn" type="button" aria-hidden="true" id="removeProductFromBasket">
